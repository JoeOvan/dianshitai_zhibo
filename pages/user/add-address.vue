			...
			<view class="address-form-wrap">
				<form @submit="saveAddress" class="address-form">
					...
					<view class="address-form-item">
						...
						<view class="form-item-wrap">
							<input name="detailInfo" type="text" placeholder-style="color:#888888" class="address-input"
					...
					<view class="address-form-item">
						...
						<view class="form-item-wrap">
							<input name="telNumber" type="number" placeholder-style="color:#888888" class="address-input"
								placeholder="请填写收货人手机号码">
						</view>
					</view>
					<!-- <view class="address-form-item">
						<view class="label" style="flex: 2;">设为默认地址</view>
						<view class="form-item-wrap">
							<view class="address-input" style="width: 213rpx;"></view>
							<view class="sex">
								<label style="margin-right: 10rpx;" @click="setDefault(1)">
								 	<view class="red radio"><view :class="{'active':isDefault==false}"></view></view>是
								</label>
								<label @click="setDefault(2)">
									<view class="red radio"><view :class="{'active':isDefault==true}"></view></view>否
								</label>
							</view>
						</view>
					</view> -->
