  ...
  <view class="wrapper">
	...
	<scroll-view class="scrollview-wrap" scroll-y="true" :refresher-enabled="refresher" :refresher-triggered="triggered"
		...
		<!-- <view class="content" :style="{'top':tabFix}"> -->
			...
			<scroll-view scroll-x="true" scroll-y="false" class="bg-white nav top-menu-view" :class="tabMenuFixed ? 'isfixed' : ''" scroll-with-animation
    ...
    <sku :isLive="isLive" :open="openSkuModal" :goodsId="goodsId" @state='closeSkuModal' @openLoginModal='isLoginModalShow = true' @closeLoginModal='isLoginModalShow = false' @skuGoodsNum="getSkuGoodsNum"  style="z-index: 999;height: 0;"></sku>
...
export default {
  ...
  data() {
    return {
	  ...
	  isLoginModalShow: false,  //是否显示登录模态框
    }
  },
  onLoad() {
    //获取胶囊高度
